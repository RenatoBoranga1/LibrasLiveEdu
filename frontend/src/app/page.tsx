            ...
            {roles.map((role) => {
              ...
              return (
                <Link key={role.href} href={role.href} className="focus-ring rounded-lg">
                  <article className="h-full rounded-lg border border-ink/10 bg-white p-5 shadow-soft transition hover:-translate-y-0.5 hover:border-ocean/40 dark:border-white/10 dark:bg-zinc-900">
